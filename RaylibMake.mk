...
CE346Final: raylib
ifneq (,$(CE346Final_config))
	@echo "==== Building CE346Final ($(CE346Final_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f CE346Final.make config=$(CE346Final_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f CE346Final.make clean
